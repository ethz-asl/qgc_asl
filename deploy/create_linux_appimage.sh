...
# copy libts-0.0-0
wget -c --quiet http://ftp.us.debian.org/debian/pool/main/t/tslib/libts0_1.19-1_amd64.deb
mkdir libts
dpkg -x libts0_1.19-1_amd64.deb libts
cp -L libts/usr/lib/x86_64-linux-gnu/libts.so.0 ${APPDIR}/usr/lib/x86_64-linux-gnu/
